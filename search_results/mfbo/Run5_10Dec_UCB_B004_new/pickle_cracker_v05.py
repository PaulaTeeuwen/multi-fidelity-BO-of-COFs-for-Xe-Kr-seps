...
pickle_dirs = [
    "/Users/paulateeuwen/GitHub/AIChemy/multi-fidelity-BO-of-COFs-for-Xe-Kr-seps/search_results/mfbo/Run5_10Dec_UCB_B100_new",
    "/Users/paulateeuwen/GitHub/AIChemy/multi-fidelity-BO-of-COFs-for-Xe-Kr-seps/search_results/mfbo/Run5_10Dec_UCB_B100",
    "/Users/paulateeuwen/GitHub/AIChemy/multi-fidelity-BO-of-COFs-for-Xe-Kr-seps/search_results/mfbo/Run5_10Dec_UCB_B100_macbook",
...
print(f"Total pickle files combined: {len(files)}")
print(files)

# Output CSV file (saved to the first directory by default)
output_dir = pickle_dirs[0]
csv_file = f"{output_dir}/iterations_accumulated_cost.csv"
...
plot_file_1 = f"{output_dir}/selectivity_vs_iterations.png"
...
plot_file_2 = f"{output_dir}/selectivity_vs_cost.png"
...
plot_file_3 = f"{output_dir}/selectivity_mean_std_iterations.png"
...
plot_file_4 = f"{output_dir}/selectivity_mean_std_cost.png"
